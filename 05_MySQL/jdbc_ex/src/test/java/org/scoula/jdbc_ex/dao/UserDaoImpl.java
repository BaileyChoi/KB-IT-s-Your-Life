...
public class UserDaoImpl implements UserDao {
    ...
    final private String USER_LIST = "select * from users";
    final private String USER_GET = "select * from users where id = ?";
    final private String USER_INSERT = "insert into users values(?, ?, ?, ?)";
    final private String USER_UPDATE = "update users set name = ?, role = ? where id = ?";
    final private String USER_DELETE = "delete from users where id = ?";
