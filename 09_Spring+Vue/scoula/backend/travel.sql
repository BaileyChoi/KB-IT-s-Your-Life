...
LOCK
TABLES `tbl_travel` WRITE;
/*!40000 ALTER TABLE `tbl_travel` DISABLE KEYS */;
INSERT INTO `tbl_travel`
VALUES (1, '수도권', '인천 개항장역사문화공간',
        '1883년 인천 개항장 126년 세월의 흔적이 쌓인 개항기 역사와 문화의 만남의 장소이다. 이곳은 옛 일본영사관인 중구청과 일본 제1은행 인천지점, 일본 제18은행 인천지점 ,일본 제58은행 인천지점 등 근대 건축을 그대로 볼 수 있는 장소이다. 이뿐아니라 일본우선주식회사나 인천의 아트플렛폼, 제물포구락부 등 역사의 흔적들을 직접 눈으로 볼 수 있고 귀로 들을 수있는 곳이다. 이곳은 인천문화 관광해설사가 배치되어 예약을 받아 해설을 하고 있다. 보다 깊은 해설을 들으며 도보관광을 즐길 수 있어 가족 단위나 여행단체의 큰 호응을 얻고 있다.',
        '인천광역시 중구 제물량로232번안길 27', '인천 중구 문화유산팀 032-760-6448'),
       (2, '수도권', '인천 월미문화의거리',
       ...
       (3, '수도권', '인천 연안부두해양광장',
        ...
        '인천광역시 중구 연안부두로 70 (항동7가)', '032-777-1330'),
       (4, '수도권', '인천 하나개해수욕장',
        ...
        '인천광역시 중구 무의동 산189번지 (무의동)', '032-751-8833'),
       (5, '수도권', '양평 세미원',
       ...
       (6, '수도권', '시흥 갯골생태공원',
        ...
        '경기도 시흥시 동서로 287 (장곡동)', '031-488-6900'),
       (7, '수도권', '고양 행주산성',
        ...
        '경기도 고양시 덕양구 행주로15번길 89', '031-8075-4652'),
       (8, '수도권', '고양 행주산성역사공원',
        '한강을 직접 만져볼 수 있는 친수공간(빨랫돌머리) 군초소 전망대(행호정), 철책 포토존, 바람개비 언덕을 갖춘 역사공원이다. 대덕생태공원~행주산성역사공원~군순찰로~장항습지 18.2km 코스가 생태테마관광 10선으로 지정되어 있다.',
        '경기도 고양시 덕양구 행주외동 140-8', '031-8075-3404'),
       (9, '수도권', '고양 행주송학커뮤니티센터',
        '해찬송학 김 전시관은 한국 최초의 김 전시관으로 김의 역사와 배경에 대해 소개하고 있는 곳이다. 관람객들은 전시관에 서 김에 대한 역사와 배경에 대해 관람할 수 있고, 대한민국을 체험할 수 있는 다양한이벤트를 경험해볼 수 있다.1층에 는 김 유물관, 김 학술관이 있어 김의 역사에 대해 알 수 있으 며, 2층에는 김 판매실이 있어 직접 설명을 듣고 맛볼 수 있다. 3층에는 대한민국의 전통을 느낄 수 있는 한복전통문화 체험관 등이 있고, 4층에는 웨딩/화보촬영을 위한 공간이 마련되어 있다.',
        '경기도 고양시 덕양구 행주산성로 38 (행주외동54-5)', '031-8075-3405'),
       (10, '수도권', '수원 화성행궁',
        ...
        '경기도 수원시 팔달구 정조로 825 (남창동)', '화성행궁 매표소 031-228-4677화성행궁 안내소 031-228-4480'),
       (11, '수도권', '수원 화성장안문',
        ...
        '경기도 수원시 팔달구 정조로 910 (장안동)', '031-251-4513'),
       (12, '수도권', '수원 화성연무대',
        ...
        '경기도 수원시 팔달구 창룡대로103번길 20 (매향동)', '031-228-2763'),
       (13, '수도권', '용인 한국민속촌',
        '한국민속촌은 오랜시간을 거쳐 전승되어 온 우리 문화 속 생활풍속을 한데 모아 내외국인 관광객에게 우리의 전통문화를 소개하기 위해 1974년에 설립되었다. 높은 교육적 가치와 관광적 가치를 지닌 한국민속촌은 설립 이후부터 지금까지 생생한 문화체험과 아름다운 자연 속의 전통문화 관광지로서 사랑받고 있다.[조선시대로 떠나는 시간여행]한국민속촌 조선시대 마을은 각 지방의 실제 가옥을 실물 그대로 이건, 복원하여 조성했다. 농악놀이, 줄타기, 마상무예, 전통혼례 등 민족 고유의 멋과 흥겨움이 살아있는 전통예술공연도 관람할 수 있다.[새롭게 만나는 전통]웰컴투조선, 추억의 그때 그놀이 등 전통을 재해석해 만들어진 다양한 테마와 콘셉의 시즌축제가 특별한 즐거움을 선사한다.[살아있는 전통체험]전통생활, 민속놀이, 전통공예를 경험해 볼 수 있는 프로그램이 가득하다. 이와 함께 일일체험학습, 청소년수련활동 인증프로그램 등 단체관람객을 위한 프로그램도 마련하고 있다.[놀이가 가득한 전통문화 테마파크]어린이 관람객을 위한 놀이동산을 운영하고 있다. 스릴만점인 15개 어트랙션을 1년 내내 즐길 수 있으며, 겨울철에는 눈썰매장도 개장한다.[충실하고 건강하게, 맛있는 대한민국]조선시대의 저잣거리를 그대로 재현한 장터에서 각 지방의 다양한 토속음식을 만날 수 있다. 천연 조미료를 사용한 친환경 전통의 맛을 즐길 수 있다.',
        '경기도 용인시 기흥구 민속촌로 90 (보라동)', '031-288-0000'),
       (14, '충청권', '보령 대천해수욕장',
        '충남 보령시 해수욕장4길 일원은 대천해수욕장이다. 이미 1930년대부터 외국인을 위한 휴양단지로 자리 잡은 서해안 최대의 해변이다. 백사장 길이만 3.5km에 폭이 100m에 달한다. 경사가 완만하고 모래가 깨끗하다. 특히 다보도와 어우러지는 노을이 아름답다. 대천해수욕장은 크게 노을광장, 머드광장 구역으로 나뉘는데 피서철에는 각기 다른 즐길거리가 펼쳐진다. 해마다 열리는 보령머드축제는 국내를 넘어 세계인의 관심을 끌고 있다. 머드검문소, 머드디스코텍 등 보령의 머드를 테마로 다채로운 행사가 펼쳐진다. 해수욕장 끝자락에는 보령머드체험관이 있다. 머드사우나와 머드온돌방, 머드셀프팩과 머드마사지 등이 가능하다.대천해수욕장에서는 해수욕 외에도 즐길 거리가 많다. 대천 짚트랙은 바다로 돌진하는 듯한 오싹한 설렘을 선사한다. 스카이 바이크는 대천해수욕장과 대천항을 오가는 전국 최초의 해상 레일 바이크다. 수면에서 8~15m 높이에 선로를 달아 바닷길을 달리게 했다. 40분간 2.3km를 왕복 운행하는데, 가능하면 바닷물이 차 있는 만조 시 탑승하기를 추천한다.',
        '충청남도 보령시 머드로 123', '041-933-7051'),
       (15, '충청권', '예산 예당관광지',
        '조선 후기의 실학자 이중환은 택리지에서 내포 땅이 충청도에서 가장 살기 좋은 곳이라고 썼다. 내포 땅이 바로 지금의 예산이다. 예당관광지는 현재 국민관광지 지정 면적 5만 6천 평 중 1만 3천 평이 조성되었다. 주요 시설은 식당, 여관, 각종 편의시설 등 대중이 이용할 수 있는 것들이며 현재까지 등산로와 주차장 시설 등 6개 시설은 조성 완료, 테마를 간직한 관광지로 변모해가고 있다. 특히 예당 저수지 주변의 산책로와 팔각정은 부산 태종대 같은 운치를 느낄 수 있도록 조성하였으며 가족단위 산책과 친구, 연인과 함께 찾아가기에 좋다.하절기에는 인근 지역 주민과 사시사철 낚시객의 명소로 활용되고 있으며 찾는 이로 하여금 호평과 함께 관광명소로 거듭나고 있다.예당관광지는 예산군 응봉면 등촌리, 후사리 일원의 4만3천평 규모에 1986년부터 조성하기 시작되었다. 현재 공공편익시설인 주차장, 야영장, 잔디광장, 산책로등 부대시설이 다양하게 조성되어 있으며 전국 제일의 저수지인 예당저수지와 접해있어 친환경적인 관광지로 개발되고있다.* 낚시 - 1962년에 만들어진 우리나라에서 가장 큰 저수지인 예당 저수지는 예산군과 당진시의 농경지에 물을 공급한다 하여 예산군과 당진시의 앞머리를 따서 이름을 지었다. 지난 40여 년 동안 중부권 최고의 낚시터로 알려져 있다. 겨울철 얼음낚시 외에 초봄부터 늦가을까지 계속 낚시할 수 있다. 주로 붕어, 잉어를 비롯해 뱀장어, 가물치, 동자개, 미꾸라지 등 민물에 사는 물고기 대부분이 있다.',
        '충청남도 예산군 예당관광로 102 예당호휴게소', '041-339-8287'),
       (16, '충청권', '예산 대흥슬로시티',
       ...
       (20, '충청권', '청주동물원',
        ...
        '충청북도 청주시 상당구 명암로 171', '청주동물원 043-201-4863'),
       (21, '충청권', '청주 명암유적지',
        ...
        '충청북도 청주시 상당구 성내로124번길 14', '043-201-4422'),
       (22, '충청권', '충주 세계무술공원',
        ...
        '충청북도 충주시 남한강로 24', '043-850-6753'),
       (23, '충청권', '충주 중앙탑사적공원',
        '국보인 충주 탑평리 7층 석탑은 남한강의 아름다운 경관과 잘 어우러져 있는 통일신라 시대의 석탑으로, 당시에 세워진 석탑 중 가장 규모가 크며, 우리나라 중앙부에 위치한다고 해서 중앙탑이라고도 부른다. 중앙탑 주변에는 조각공원이 만들어져 있으며, 넓은 잔디밭이 깔려있는데, “문화재와 호반예술의 만남”이라는 주제로 국내 조각가들의 작품 26점을 전시한 충북 최초의 야외 조각 공원이다. 사적공원은 시민들의 공원으로 자리 잡기 위해 파고라와 조형물, 어린이들을 위한 간이 분수 및 산책로를 조성하였다. 그리고 중앙탑공원 내에는 충주박물관 1관, 충주박물관 2관, 야외박물관, 야외음악당, 음악분수 1기, 중앙탑, 경기 운영소, 간이 분수, 파고라, 10여 개의 조형물 등이 있다.이러한 시설을 바탕으로 중앙탑 사적공원은 충주 시민들의 쉼터와 어린이 학습 체험 장소가 자리잡았으며, 중앙탑공원 북쪽에 있는 충주조정지댐과 더불어 충주 시민의 위락 시설로 이용되고 있다. ',
        '충청북도 충주시 중앙탑면 중앙탑길 112-28', '043-842-0532'),
       (24, '충청권', '충주 충주호체험관광지',
        '충주댐 건설로 생긴 충주호는 ‘내륙의 바다’라 불릴 정도로 규모가 크다. 댐 건설로 충주, 단양, 제천 등 3개 지자체에 걸쳐 66.48㎢가 수몰됐고, 약 5만명의 수몰 이주민이 생겨 고향을 잃은 이들에겐 가슴 아픈 기억의 장소지만, 지금은 많은 관광객이 찾는 명소가 됐다. 충주, 단양, 제천 3개 지자체에 걸쳐 있는 호수이기에 주변으로 월악산국립공원, 송계계곡, 청풍 문화재단지, 단양 8경, 고수동굴, 구인사, 수안보온천, 노동동굴 등 수많은 관광자원들을 보유하고 있다. 충주호에는 충주댐 본 댐의 충주나루, 월악산 비경 아래의 월악나루, 청풍문화재단지 인근의 청풍나루, 단양팔경의 구담봉, 옥순봉이 있는 장회나루, 단양읍의 단양나루 등 총 5개의 유람선 선착장이 설치되어 있어 충주호 관광선을 이용하여 호반의 정취를 즐길 수 있도록 하였다. 충주댐 나루에서 장회나루까지의 뱃길은 대략 1시간 30여 분이 소요되는 장거리 코스이며, 수려한 선상 관광의 정수를 느낄 수 있는 매력적인 관광 코스이다. 충주호와 월악산 영봉이 한 눈에 들어오는 월악나루 주변의 풍경뿐만 아니라, 청풍나루~장회나루 구간에 있는 기암절벽의 암봉들과 어우러진 단양팔경(구담봉, 옥순봉) 선상 관광은 충주호 뱃길 여행 중 가장 빼어난 곳이라 할 수 있다.',
        ' ', '043-850-5114'),
       (25, '충청권', '제천 청풍호유람선',
        ...
        '충청북도 제천시 청풍면 청풍호로50길 6', '청풍호유람선 043-644-8859'),
       (26, '충청권', '제천 청풍호반케이블카',
        ...
        '충청북도 제천시 청풍면 문화재길 166 (청풍면)', '043-643-7301'),
       (27, '충청권', '단양 온달관광지',
        '온달관광지는 온달전시관, 온달오픈세트장, 온달동굴, 온달산성으로 구성된다. 온달전시관은 고구려 고분의 형상을 모티브로 설계했으며 전시장 내부는 온달 장군의 투구를 본떠 만들었다. 온달이 평강 공주의 도움을 받아 장군으로 성장하는 과정을 역사적 사료를 통해 관람할 수 있다. 온달오픈세트장은 온달관광지에서도 가장 인기 있는 코스로 고구려 시대의 궁궐, 주택, 저잣거리 등을 다채롭게 재현해 드라마와 영화 촬영 세트장으로 활용되고 있다. 약 4억 5천만 년의 세월을 품은 온달동굴은 신비로운 모양의 종유석, 석순이 많이 발달해 있으며, 30분 정도 거닐며 웅장한 풍경을 감상할 수 있다.',
        '충청북도 단양군 영춘면 온달로 23', '043-423-8820'),
       (28, '충청권', '단양 다리안관광지',
        '소백산국립공원 진입 관문에 위치한 다리안국민관광지는 소백산 깊은 계곡에서 흘러나오는 깨끗한 물줄기가 다리안 관광지를 휘돌아 흐르며 깊은 골짜기에서 배어 나오는 상큼한 공기는 찾는 이의 마음을 상쾌하게 해주는 곳이다. 용이 승천하였다는 전설을 간직한 다리안계곡을 주위로 3대동굴과, 소백산등이 있어 등산과 피서, 휴양을 겸한 관광지로서 좋은 곳이다.',
        '충청북도 단양군 단양읍 소백산등산길 12', '다리안 관광지 관리사무소 043-423-1243'),
       (29, '전라권', '익산 교도소세트장',
        '성당면 와초리 성당초등학교 남성분교 폐교부지 위에 세워 진 국내 유일의 영화 촬영용 교도소세트장의 입구에는 그동 안 촬영된 영화 포스터들을 전시하고 있다. 딱딱하고 경직된 회색의 높은 담장이 주위를 둘러싼 교도소 이미지를 탈바꿈 한 이곳은 과거 아이들이 다니던 초등학교였으나, 폐교를 세 트장으로 활용하고 있으며, 또한 운동장에 깔린 천연잔디는 관광객들의 휴식공간으로 각광받고 있다.',
        '전라북도 익산시 성당면 함낭로 207', '063-859-3836'),
       (30, '전라권', '익산 고스락',
        ...
        '전라북도 익산시 함열읍 익산대로 1424-14', '063-861-2288'),
       (31, '전라권', '군산 시간여행마을',
        ...
        '전라북도 군산시 내항1길 8 (장미동)', '063-446-5114'),
       (32, '전라권', '군산 경암동 철길마을',
        '페이퍼 코리아 공장과 군산역을 연결하는 2.5km의 철로 주 변의 마을을 총괄하여 붙여진 이름이다. 경암동 철길은 1944년 일제강점기 시절 신문 용지 재료를 실어나르기 위해 최초로 개설되었으며, 개설된 철도 주변에 사람들이 모여 살기 시 작하며 동네를 이루었다. 1970년대 들어 본격적으로 마을이 형성되었으며, 마을이 위치한 행정 구역 명칭에 따라 철로 주 변에 형성된 마을을 경암동 철길 마을이라 부르기 시작했다',
        '전라북도 군산시 경촌4길 14', '061-454-4000'),
       (33, '전라권', '무주 반디랜드',
       ...
       (34, '전라권', '완주 삼례문화예술촌',
        '삼례문화예술촌은 1920년대 산미증식계획과 함께 호남지방 수탈이 가속되던 때, 삼례역을 통해 일본으로 양곡을 반출할 목적으로 만들어진 창고에 기반하고 있다. 해방 이후 2010년까지 농협 창고로 사용되었던 건물을 완주군이 매입하여 지역 재생을 통한 문화공간으로 조성하였고, 2013년 6월 개관 이후 삼례문화예술촌은 지역 문화 활성화를 위한 중추적 역할을 담당하고 있다.2021년은 개관 9년차를 맞아 시설(경관) 개선 사업과 함께 신규 콘텐츠 준비로 제1전시관, 다목적공간, 공연장, 소매점 등 일부 시설을 운영 중에 있다.제1전시관은 1920년대 일제강점기 양곡 창고를 리모델링한 공간으로서 높은 층고와 함께 양곡 적재를 위한 목조 구조가 드러나 있어 역사적 의미가 담겨있는 곳이며, 다목적공간과 야외광장은 주민들이 문화의 주체가 되어 활동할 수 있도록 세미나, 전시, 체험 등으로 활용하고 있다.',
        '전라북도 완주군 삼례읍 삼례역로 81-13', '070-8915-8121'),
       (35, '전라권', '진안 마이산도립공원 남부',
        ...
        '전라북도 진안군 진안읍 마이산로 130', '063-430-8751~3'),
       (36, '전라권', '진안 마이산도립공원 북부',
        '진안읍내 어느 방면에서나 눈에 띄는 마이산은 이름이 철에 따라서 네 가지이다. 봄에는 안개를 뚫고 나온 두 봉우리가 쌍돛배 같다하여 돛대봉, 여름에 수목이 울창해지면 용의 뿔처럼 보인다고 용각봉, 가을에는 단풍 든 모습이 말의 귀 같다 해서 마이봉, 겨울에는 눈이 쌓이지 않아 먹물을 찍은 붓끝처럼 보여 문필봉이다. 마이산 오르는 길은 두 가지가 있다. 하나는 유명한 마이산 탑사가 있는 남쪽에서 오르는 코스이고 다른 하나는 북쪽에서 내려가는 코스이다. 마이산에는 조선시대 태조가 임실군의 성수산에서 돌아가다가 백일기도를 드렸다는 은수사, 강한 비바람에도 쓰러지지 않는다는 80여개의 돌탑을 거느린 탑사 등이 있다.마이산은 소백산맥과 노령산맥의 경계에 넓게 펼쳐져 있는 말의 귀모양으로 생긴 두 봉우리를 말하는 것으로 섬진강과 금강의 분수령을 이루고 있다. 동쪽에 솟아있는 숫마이봉은 667m이며, 서쪽에 솟아있는 암마이봉은 673m이다. 마이산은 전체가 바위로 되어 있으나 관목과 침엽수, 활엽수 등이 군데군데 자라고 있으며, 화암굴, 탑군, 금당사 등이 있다. 특히, 두 봉우리 사이의 남쪽 계곡에는 돌로 쌓은 수십 기의 마이산 탑사가 있기도 하다. 마이산에는 놀이와 휴식에 적합한 관광 등산코스로도 유명하다. 또한 입구 3km 진입로에는 벚꽃나무가 터널을 이루고 있어 매년 벚꽃이 만개하는 4월 중순경에 남부주차장 입구에서 진안군 주관으로 벚꽃축제가 열리고 있다. 주요행사 내용은 군민노래자랑, 좌도농악공연, 벚꽃 축제한마당, 향토특산물 전시판매장 등이 개설되며, 군민 화합의 축제 한마당이 되고 있다.',
        '전라북도 진안군 진안읍 마이산로 130', '063-430-8751~3'),
       (37, '전라권', '전주향교',
        '고려 말에 현유(賢儒)의 위패를 봉안, 배향(配享)하고 지방민의 교육과 교화를 위하여 창건되었다. 당시의 위치는 현재 경기전(慶基殿) 근처였으나 태조(太祖) 이성계의 수용(?容)을 봉안하기 위하여 경기전이 준공되자 1410년(태종 10) 전주성의 서쪽 황화대(黃華臺) 아래로 이전하였다. 그 뒤 1603년(선조 36) 순찰사 장만(張晩)이 좌사우묘지제(左社右廟之制)에 어긋난다 하여 조정에 보고, 왕의 재가를 받아 현재의 위치로 이전하였다. 1654년(효종 5)·1832년(순조 32)·1879년(고종 16)·1904년에 중수하였고, 1922년에 명륜당을 보수하였다. 조선 후기의 경내 건물로는 3칸의 대성전, 각 10칸의 동무(東?)와 서무(西?), 신문(神門), 외문(外門), 만화루(萬化樓), 5칸의 명륜당, 각 6칸의 동재(東齋)와 서재(西齋), 3칸의 계성사(啓聖祠), 신문(神門), 입덕문(入德門), 4칸의 사마재(司馬齋), 6칸의 양사재(養士齋), 2칸의 책판고(冊板庫), 직원실, 제기고(祭器庫), 수복실 등 총 99칸인 대규모의 건물로 되어 있었다. 따라서 이 향교는 전라도 53관의 수도향교(首都鄕校)라 칭하였다. 그 뒤 만화루는 1886년(고종 23)에 홍수로 수몰되었고, 책판고는 관찰사 조한국(趙翰國)이 관고(官庫) 소유 책판을 전주향교로 이장하여 책판고 내에 관리하도록 하였는데, 1920년의 홍수와 1950년 6·25전쟁으로 거의 없어지고 말았다. 이 향교의 대성전은 전라북도 유형문화재로 지정되어 있으며, 5성(五聖)·10철(十哲)·송조 6현(宋朝六賢)의 위패를 봉안하고 있다. 또 동무·서무에는 유약(有若)·복불제(宓不齊)·복승(伏勝)·동중서(董仲舒)·한유(韓愈)·이통(李?)과 우리나라 18현(十八賢)의 위패를 봉안하고 있다.',
        '전라북도 전주시 완산구 향교길 139 (교동)', '063-288-4548'),
       (38, '전라권', '전주 오목대',
        ...
        '전라북도 전주시 완산구 기린대로 55', '오목대 관광안내소 063-282-1335'),
       (39, '전라권', '전주 한옥마을',
       ...
       (42, '전라권', '전주 동물원',
        ...
        '전라북도 전주시 덕진구 소리로 68', '063-281-6759'),
       (43, '전라권', '전주 덕진공원',
        ...
        '전라북도 전주시 덕진구 권삼득로 390', '063-239-2607'),
       (44, '전라권', '부안 변산해수욕장',
        '서해안의 대표적인 해수욕장이다. 하얀 모래와 푸른 솔숲이 어우러졌다 하여 \'\'백사청송\'\'해수욕장으로도 불린다. 또한 우리나라에서 가장 오래된 해수욕장의 하나로 1933년에 개장되었다. 곱디 고운 모래해변이 끝없이 펼쳐져 있으며 서해안의 해수욕장치고는 물빛도 맑은 편이다. 더욱이 평균수심이 1m밖에 되지 않고 수온이 따뜻해서 해수욕장 조건이 아주 좋다.',
        '전라북도 부안군 변산면 변산로 2076', '063-583-6951'),
       (45, '전라권', '부안 모항해수욕장',
        '바다를 낀 변산반도 국립공원 해안도로에서 변산과 격포를 거쳐 곰소로 가다보면 모항해수욕장을 만날 수 있다. 모항해수욕장은 아담한 백사장과 울창한 소나무밭이 아름다운 조화를 이룬다. 규모는 작지만 서해의 다른 해변과 달리 물이 빠져 해변이 드러나도 하얀 모래가 가득하고, 해수욕장 곳곳에서 바다낚시와 선상낚시를 즐길 수 있다.변산반도 일대에서 가장 한적한 해수욕장으로, 2000년 12월에 관광지로 조성되었고, 가족호텔, 가족휴양촌 등 각종 숙박시설과 해변카페 등이 조성되었다. 주변에는 모항갯벌체험장, 호랑가시나무군락지(천연기념물)가 있으며 격포항에서 모항으로 가는 환상적인 드라이브 코스가 있다. 빼어난 풍경의 갑남산을 끼고 있는 모항해수욕장은 갯바위 낚시와 갯벌 체험장으로 가족여행객들의 발길을 사로잡고 있으며 해안가에 즐비하게 늘어선 해송은 모항해수욕장의 랜드마크가 됐다. 또한 전국 사진작가들의 일몰 포인트로 많은 사랑을 받고 있다.',
        '전라북도 부안군 변산면 모항길 22', '063-580-4413'),
       (46, '전라권', '임실 치즈테마파크',
        ...
        '전라북도 임실군 성수면 도인2길 50', '063-643-9540'),
       (47, '전라권', '임실 옥정호외얏날',
        ...
        '전라북도 임실군 운암면 입석리 458', '063-640-4082'),
       (48, '전라권', '장수 와룡 자연휴양림',
        ...
        '전라북도 장수군 천천면 비룡로 632', '063-350-2477'),
       (49, '전라권', '장수누리파크',
        ...
        '전라북도 장수군 장수읍 논개사당길 65', '관리사무소(홍보관) 063-352-5660'),
       (50, '전라권', '장수 방화동 자연휴양림',
        '방화동자연휴양림·가족휴가촌 기본 정보 전국 8대 종산에 속하는 장안산(1,237m)의 방화동계곡에 조성된 방화동자연휴양림·가족휴가촌은 덕산용소에서 방화동계곡으로 연계되는 코스에 방화폭포, 산림욕장(치유의 숲, 만남의 광장) 시설이 갖추어져 있으며, 깨끗한 계곡을 따라 기암절벽, 다양한 수목 등의 수려한 자연경관으로 가족단위 주말 또는 단기체류형으로 최적의 조건을 갖춘 사계절 매력적인 휴양처다.높은 산이 많은 장수군 특성상 지형적으로 해발 500m 이상의 고지대에 위치하고 있어 기온이 낮으며, 해발 1,000m가 넘는 큰 산들로 둘러 쌓인 방화동자연휴양림은 웰빙 시대에 맞춰 통나무집 4동과 산림문화휴양관등 숙박시설 및 세미나를 위한 영상과 방송시설, 식당 등이 갖춰져 있으며, 방화동가족휴가촌에는 숙박시설(다문화체험동,가족휴양동)을 비롯하여 오토캠핑장, 캠핑카 야영장, 목재문화체험장,취사장을 비롯한 각종 편익시설을 갖추어져 있습니다. 특히 전국 최고의 오토캠핑 시설 등이 수려한 방화동 계곡을 끼고 조성되어 있습니다.',
        '전라북도 장수군 번암면 방화동로 778', '063-350-2474'),
       (51, '전라권', '장수 뜬봉샘 생태관광지',
        ...
        '전라북도 장수군 장수읍 물뿌랭이길 10-18', '뜬봉샘생태공원 063-353-7002'),
       (52, '전라권', '고창 선운산 도립공원',
       ...
       (55, '전라권', '곡성 섬진강 기차마을',
        ...
        '기차마을 입장권 및 기타 문의 : 061-362-7461 / 8635증기기관차 및 기차마을레일바이크 : 061-363-9900 / 6174섬진강레일바이크 : 061-362-7717'),
       (56, '전라권', '남원관광지',
        '지리산의 서북쪽 관문인 남원은 옛날부터 정치,군사상 중요한 거점이었다. 남원은 우리 고전문학 작품에서 가장 널리 알려진 춘향전의 무대이기도 하다. 매월당 김시습의 한문 단편소설인 만복사저포기도 남원을 배경으로 삼고 있다. 남원은 전라북도의 교통 중심지로 지리산, 덕유산, 속리산을 연결하는 관광객의 숙박 및 위락 기능을 맡고 있는 도시이다.88 올림픽 고속도로의 개통을 계기로 경주 보문단지와 제주 중문단지에 견줄만한 관광도시의 틀을 갖추고자 추진한 것이 남원관광지이다. 남원시는 광한루원 앞으로 흐르는 요천 건너 어현동의 산허리를 깎아 40여만평의 터에 남원의 전통을 되살리고 광한루와 만인의총, 황산대첩비지, 실상사, 지리산 그리고 구례 화엄사, 덕유산 등을 연계하는 관광도시를 건설함으로써 관광도시 기반의 확충과 서남권 관광의 중심부 역할을 할 것으로 기대하고 있다.현재 국립민속국악원과 춘향문화예술회관, 춘향테마파크, 향토박물관을 비롯하여 위락시설, 남원랜드, 숙박업소,전문 음식점, 전망대 등의 시설과 주변의 극락암, 덕음암 및 빙고치, 천연동굴들로 연결되는 산책로가 조성되어 있고 넓은 광장 앞을 흐르는 요천수에 고무댐을 만들어 조성한 수상유원지와 함께 훌륭한 관광휴식처를 제공하고 있다. 남원관광지와 광한루원을 연결하는 승월교는 마치 은하수를 건너는 오작교를 연상시키고 가히 환상적인 분위기를 연출한다. 최근에는 임권택감독이 만든 영화 \'\'춘향전\'\'의 촬영세트도 그대로 보존되어 있다.',
        '전라북도 남원시 양림길 43 (어현동)', '063-620-6160'),
       (57, '전라권', '남원 국악의 성지',
        '지리산 자락 황산 기슭에 위치한 곳으로, 국악전시 체험관, 독공실, 야외공연장, 국악인 묘역, 사당 등의 시설물로 이루어져 있고, 판소리를 비롯한 우리 음악의 모든 것을 알 수 있는 곳이다.',
        '전라북도 남원시 운봉읍 비전길 69', '063-620-5740~2'),
       (58, '전라권', '남원 지리산 허브밸리',
        ...
        '전라북도 남원시 운봉읍 바래봉길 214', '070-7764-0130'),
       (59, '전라권', '남원 백두대간 생태교육장 전시회',
        '지리산의 상징성과 백두대간의 역사·생태·보존의 최적지ㅁ인 남원에 백두대간 생태교육장 전시관이 조성되었다. 전시관은 한반도 지도 형상을 본 따 만든 곡선의 전시관 지붕외관에서부터 우리나라의 중심축인 백두대간의 모든 것을 알고 보고 체험 할 수 있는 갖가지 내용물 등이 전시되어 있다. 전시관 주요시설로는 상설전시실, 기획전시실, 호남 최초로 시도하는 5D서클영상관, 카페테리아 등이 있으며 부대시설로는 야외공연장, 곤충온실, 체육시설 등이 있다.',
        '전북 남원시 운봉읍 운봉로 151', '063-620-5752'),
       (60, '전라권', '남원 광한루원',
       ...
       (61, '전라권', '남원관광지',
        ...
        '전라북도 남원시 양림길 43 (어현동)', '063-620-6160'),
       (62, '전라권', '남원항공우주천문대',
        '남원항공우주천문대는 2006년 과학기술부 지방천문과학관 지원 사업으로 선정되어 사업비 46억원에 부지면적 6,532㎡, 지상3층 규모로, 우주항공의 발자취를 한눈에 볼 수 있는 전시실과 항공기 비행 체험을 위한 공간인 항공체험관, 10m 크기의 돔 스크린에 밤하늘과 전천영상을 볼 수 있는 천체 투영실이 있다. 남원의 밤하늘을 관측할 수 있는 600mm 규모의 주망원경과 350mm - 125mm까지의 다양한 구경과 다양한 방식의 망원경을 구비한 보조관측실이 있다. 특히, 주관측실의 600mm 규모의 주망원경은 약 15.7등급까지 수십 만개의 별을 볼 수 있을 뿐 아니라 성운, 성단, 은하 등의 천체까지 관측이 가능하다. 이와 함께 실외에는 1970년대 우리나라 공군의 주력기이었던 팬텀기를 비롯한 다양한 전투기가 전시됐다.남원우주항공천문대는 그 특성상 박물관 또는 전시관과 같이 대단위 인원이 자유롭게 둘러보는 방식이 아닌 실별로 인원을 나눠서 관람하는 시설로 꾸며져 있다. 남원천문대는 태양과 천체관측 4D 영상관람, 가상항공체험, 천문강연 등의 프로그램을 교대로 운영하며 1회 최대 120명을 수용할 수 있다. 특히 남원천문대는 여름방학 캠프를 비롯하여 하반기 현장체험 학습과 다채로운 과학체험교실을 운영, 관람객 유치와 함께 지방과학문화를 선도하는 중추적인 과학관으로 자리매김하고 있다.',
        '전라북도 남원시 양림길 48-63 (노암동)', '남원항공우주천문대 063-620-6900'),
       (63, '전라권', '순천 드라마촬영장',
       ...
       (66, '전라권', '순천 순천만 습지',
        ...
        '전라남도 순천시 순천만길 513-25 (대대동)', '1577-2013061-749-6052'),
       (67, '전라권', '여수 오동도',
        ...
        '전라남도 여수시 오동도로 222', '061-659-1819'),
       (68, '전라권', '여수 해양공원',
       ...
       (69, '전라권', '장흥 편백우드랜드',
        ...
        '전라남도 장흥군 장흥읍 우드랜드길 180 (장흥읍)', '061-864-7911'),
       (70, '전라권', '완도타워',
        ...
        '전라남도 완도군 완도읍 장보고대로 330', '061-550-6964'),
       (71, '전라권', '완도 신지 명사십리해수욕장',
        ...
        '전라남도 완도군 신지면', '061-550-6921'),
       (72, '전라권', '완도 정도리 구계등',
        '정도리구계등 해변에는 억겁의 시간 동안 거센 파도에 닳은 갯돌이 모난 구석 하나 없이 둥그스름하게 연마되어 있다. 크고 작은 돌이 해변뿐만 아니라 바다 아래로 아홉 계단을 이루고 있다 하여 구계등으로 불린다. 약 800m 길이의 자갈밭은 해안선이 감싸고 있는 형태로 장관을 이룬다. 해변 뒤로는 상록수와 단풍나무로 방풍림이 조성되어 있어 해수욕과 산림욕을 동시에 누릴 수 있다. 특히 정도리구계등은 주변의 크고 작은 203개의 섬과 기암절벽 등 멋진 경관으로 이른 아침 일출을 구경하는 장소로 유명하며, 명승 제3호로 지정되었다.',
        '전라남도 완도군 완도읍 정도리 152-1', '061-554-1769'),
       (73, '경상권', '대구 근대골목',
        ...
        '< 계산예가 관광안내소 > 대구 중구 서성로 6-1 (이상화고택 맞은 편, 미소시티아파트 뒤)< 쌈지공원 관광안내소 > 대구 중구 국채보상로102길 66 (만세계단 밑 쌈지공원, 계산성당 맞은 편)< 김광석길 관광안내소 > 대구 중구 대봉동 1-20번지(새주소 달구벌대로 2232) (골목방송스튜디오 안, 방범초소 옆)',
        '053-661-3323053-661-3327053-661-3328'),
       (74, '경상권', '대구 사문진주막촌',
        ...
        '대구광역시 달성군 화원읍 사문진로1길 40-12', '053-632-3338'),
       (75, '경상권', '대구 비슬산군립공원',
        '비슬산 자연휴양림은 대견봉(1083.59m)을 중심으로 좌우에 조화봉(1,058m), 관기봉(990m)을 거느린 341ha의 면적에 사계절 자연의 아름다움을 전한다. 비슬산 자연휴양림의 가장 큰 특징은 주변의 뛰어난 자연경관은 그대로 활용해 휴식공간과 편의시설을 갖췄다는 것이다. 집채만한 바위가 산기슭에 군락을 이루듯 펼쳐진 수백개의 바위 마당 과 계곡 곳곳에 숨은 듯 자리잡은 기암 괴석은 보는 이의 탄성을 절로 자아낸다. 또한 휴양에 필요한 각종 편의시설이 잘 설치되어있는 것도 장점이다. 아울러 매년 4월 중순에서 5월 초인 비슬산 정상 30만평에 참꽃물결을 이루고 여름엔 안개분수를 이용한 무지개계곡 가을엔 오색단풍의 정취를 맛보는 가을등산, 겨울엔 얼음을 소재로한 동굴, 빙벽, 얼음탑, 썰매장, 고드름 동산 등 오색조명을 이용한 겨울밤은 전국 유일의 자연얼음동산으로 청소년들에겐 방학기간 자연학습관으로 큰 인기이다. 휴양에 숲속의 집과 야영장, 야외강당, 연못, 청소년수련장, 체력단련장, 잔디광장, 사진촬영소, 어린이놀이터, 폭포샤워장, 물놀이터, 삼림욕장 등과 자연석들이 널려 있는 산책로인 탐석로가 있다.',
        '대구광역시 달성군 유가읍 일연선사길 61', '053-659-4400~1'),
       (76, '경상권', '부산 해운대해수욕장',
       ...
       (82, '경상권', '산청 전통한방 휴양관광지',
        ...
        '경상남도 산청군 금서면 동의보감로555번길 45-6', '055-970-7216'),
       (83, '경상권', '김해 낙동강 레일파크',
        ...
        '경상남도 김해시 생림면 마사로473번길 41', '055-333-8359'),
       (84, '경상권', '김해 봉하마을',
       ...
       (85, '경상권', '김해 가야테마파크',
        '김해시민의 일상 문화 휴식 공간. 바쁜 현대인의 일상에 편안한 휴식을 제공하는 일상휴식공간이며 가족/연인/친구와 함께 다양한 문화를 접할 수 있는 복합문화공간입니다. Education + Entertainment 체감형 테마파크. 우리민족의 찬란한 유산인 가야의 역사를 놀이, 체험, 전시를 통해 보고, 듣고, 만지며 배울 수 있는 에듀테인먼트파크입니다.',
        '경상남도 김해시 가야테마길 161 (어방동)', '055-340-7900'),
       (86, '경상권', '김해한옥체험관',
        '김해 한옥체험관은 우리나라의 전통 문화와 한옥의 운치를 고스란히 느낄 수 있는 한옥 체험 숙소이다. 안채, 사랑채, 별채에 마련된 객실은 저마다 특징이 달라 취향에 따라 선택할 수 있다. 안채에 마련된 객실은 고가구와 방석, 편지꽂이, 등잔 등 전통 소품으로 장식해 옛 선조들의 일상을 엿볼 수 있다. 널찍한 대청마루는 회의실로 이용 가능하다. 사랑채 객실은 안채에 비해 아담하고 소박하지만 소파와 테이블이 놓인 누마루가 있어 바깥 풍경을 즐기며 휴식을 취하기 좋다. 김해한옥체험관에서 가장 고풍스러운 객실은 별채에 자리한 월파실과 함허실이다. 객실에 들어서면 커다란 병풍이 둘러쳐진 전통 보료(앉는 자리에 늘 깔아두는 두툼한 요)가 눈길을 사로잡는다. 사극에서 봤음직한 옛날 방 풍경을 그대로 옮겨놓은 듯하다. 전통 한옥이지만 모든 객실에 TV, 냉장고, 에어컨, 현대식 화장실을 갖춰 편리함을 더했다. 때때로 전통 체험 프로그램을 운영하며 외국인 여행객을 위해 영어, 일본어 안내 서비스를 제공한다.',
        '경상남도 김해시 가락로93번길 40', '055-322-4735~6'),
       (87, '경상권', '고성 당항포관광지',
        ...
        '경상남도 고성군 회화면 당항만로 1116', '055-670-4501'),
       (88, '경상권', '거제 수협효시공원',
        '우리나라 수산업 협동조합의 시작을 알린 가조도. 1908년 대한제국의 농공상부대신의 인가를 받은 거제한산가조어기조합과 거제한산모곽전 조합의 설립을 기념하기 위하여 거제시 사등면 가조도에 수협효시공원이 조성되었다.',
        '경상남도 거제시 사등면 가조서로 7', '055-639-8340'),
       (89, '경상권', '거제 칠천량해전공원',
        ...
        '경상남도 거제시 하청면 칠천로 265-39', '055-639-8250'),
       (90, '경상권', '거제 포로수용소 유적공원 평화파크',
        '거제시청이 위치한 신현읍 고현리에 있는 6.25 당시의 가장 큰 포로수용소 유적이다. 거제 계룡산(554m) 동쪽 자락을 따라, 복원된 옛 고현성과 그 옆 시청 건물을 지나면 고현중학교 담벼락 좌측 언덕에 포로수용소 경비대 건물 잔해가 서 있는 모습을 볼 수 있다. 유적관 내에는 전시실, 영상실, 기념품 판매소가 설치되어 있으며, 전시실에는 포로의 발생, 배경, 생활사, 포로 유품, 폭동, 석방 등이 전시되어 있고, 영상실에는 당시 촬영한 필름과 포로 출신 인터뷰를 통하여 10분간 포로에 대한 내용을 상영하며 상징 조형물은 \"전쟁, 분단, 그리고 화합\"이라는 제목으로, 한국 전쟁 당시의 상황은 찌그러진 철모에 생긴 총알구멍을 보면 치열했던 전투를 추측할 수 있으며, 전쟁으로 인해 사로잡힌 많은 포로들이 이곳 거제도에 수용되었다.철조망을 걷어내는 국군과 북한군의 모습은 한민족 간의 화합으로 통일을 이룩하고자 하는 강한 의지를 표현한 것이다. 당시 포로수용소 막사는 공산 포로들의 지휘본부 역할을 했던 78수용소의 입구를 그대로 재현시켜 형상화하였고, 64야전 병원은 경비병과 포로폭동등으로 부상당한 포로의 의료를 담당했던 곳이다. 당시 17만여 명의 포로들의 음식을 배급하는 취사장과 그 내부를 볼 수 있는 곳이며, 노천 변소 아래 놓인 변기통은 당시 극렬했던 친공 포로들이 인민재판으로 반동분자를 색출, 그 자리에서 곤봉과 돌멩이로 쳐죽여 토막 난 시체를 담아서 고현만에다 버리는 도구를 사용하기도 했던 비참한 생활상을 상기시키는 것이다. 중공군 포로 막사 앞에 서있는 사자상은 중국 포로들이 의전행사나 기념일이 있을 때 사용하기 위하여 만들어진 사자상이다. 6.25당시 사용하던 M463-7를 비롯하여 헬기, 8미리곡사포, 지휘용 장갑차, 함포 등이 당시 경비본부와 탄약고가 함께 전시되고 있다. 당시의 처참했던 상황을 연상케하는 기존 유적지의 잔해들이 연계되어 볼 수 있다.',
        '경상남도 거제시 계룡로 61 (고현동)', '055-639-0625'),
       (91, '경상권', '통영 케이블카',
        ...
        '경상남도 통영시 발개로 205', '1544-3303'),
       (92, '강원권', '춘천 박사마을 어린이 글램핑장',
        ...
        '강원도 춘천시 서면 박사로 770', '033-240-1791'),
       (93, '강원권', '춘천 소양강 스카이워크',
        ...
        '강원도 춘천시 영서로 2663 (근화동)', '033-240-1695'),
       (94, '강원권', '춘천 의암호 킹카누',
        '킹카누 나루터는 국내 유일의 캐나디안 카누 체험으로 사단법인 물길로 장목순 대표가 최로로 12인승 캐나디안 카누를 설계, 제작했으며, 기름 냄새나 소음이 없는 무동력 친환경 레포츠다. 고요한 호수 위 카누에 앉으면 수면과 시야가 수평에 가까워지기 때문에 땅에서 보는 것과 또 다른 세상을 만날 수 있다. 2019 열린 관광지로 선정되어, 19년 11월 휠체어 탑승가능 카누와 진입로 확보, 장애인 화장실 및 촉지?음성안내판 등 누구나 카누를 즐길 수 있도록 열린 관광지 시설을 완비했다. 킹카누 체험은 의암댐, 붕어섬, 하중도, 의암호 등 네 가지 대표 코스로 운영되며, 안전교육을 포함해 1시간30분 남짓 한 시간이 소요된다.',
        '강원도 춘천시 송앙동 684 (송암동)', '033-251-9600'),
       (95, '강원권', '춘천 남이섬',
        ...
        '강원도 춘천시 남이섬길 1 남이섬', '031-580-8114'),
       (96, '강원권', '횡성 호수길 5구간',
        '횡성호와 주변 산을 테마로 하여 갑천면 일원에 총 31km, 6코스로 조성했다. 1코스 횡성댐길(횡성댐~대관대리), 2코스 능선길(대관대리~횡성온천), 3코스 치유길(횡성온천~화전리), 4코스 사색길(화전리~망향의 동산), 5코스 가족길(망향의 동산), 6코스 회상길(망향의 동산~횡성댐), 이렇게 테마별로 구성되어 있다. 1.5km 코스는 1시간 내외로 걸을 수 있으며 가장 긴 7.0km 구간은 2시간 반 정도 소요된다. 5코스 가족길에서 풍광이 단연 으뜸인 망향의 동산은 2000년 횡성댐이 건설되면서 수몰된 갑천면의 5개 마을 주민들이 고향을 그리며 잊지 않기 위해 만든 것이다.',
        '강원도 횡성군 갑천면 구방리 512(태기로 구방5길 40)', '033-343-3432'),
       (97, '강원권', '횡성 유현문화관광지',
        '평화롭고 고즈넉한 풍광에서 한적한 시간을 보내기 좋은 관광지다. 그 중심에는 한국인 신부가 지은 국내 최초의 성당인 풍수원성당이 자리한다. 빨간 벽돌과 종탑 등 고딕 양식으로 지은 성당 건축물은 시대를 초월해 여전히 아름다운 자태를 뽐낸다. 1801년 신유박해 이후 신자들이 피난처를 찾다 정착한 곳으로 국내의 성지 순례지로도 유명하다. 풍수원성당 내외부를 감상한 후 주변을 따라 걸으면 박해 당시 어려웠던 생활상을 보여주는 유물이 전시된 유물전시관을 만날 수 있다.',
        '강원도 횡성군 서원면 경강로유현1길 50', '033-340-5986~8033-342-0035(전기 카트 탑승 신청 문의)'),
       (98, '강원권', '속초 아바이마을',
        '청호동에 형성된 아바이마을은 실향민의 아픔이 진하게 배어나는 곳이다. 6.25 한국전쟁 당시 북에서 내려온 피란민들이 정착하면서 마을이 형성되었는데 특히 함경도에서 온 실향민들이 많이 살고 있다. 아바이는 함경도 사투리로 할아버지와 같이 친근하고 나이가 지긋한 남자를 뜻한다. 아바이마을은 역사의 뒤안길로 사라져가는 실향민들의 삶과 생활상을 엿볼 수 있는 곳이다. 지금은 옛 모습이 많이 사라졌지만 골목길에 대문도 없는 판자집들이 드문드문 남아 있어 있으며 고향에 대한 그리움을 담은 벽화들이 담벼락을 따라 이어져있다. 고기잡이와 막일을 하며 고향에 돌아가기만을 손꼽아 기다렸던 실향민들의 고된 삶과 애환을 느낄 수 있다. 아바이마을 초기에 지어졌던 피란민 가옥들은 속초시립박물관 실향민 문화촌에 복원되어 있다. 아바이마을은 드라마 <가을동화> 촬영지로 이름난 후 사람들이 많이 찾아오기 시작하면서 속초의 대표적인 관광지로 자리매김했다. 식당가 골목에 함흥냉면과 오징어순대, 아바이순대국 등 북한의 향토 음식점들과 카페들이 즐비하게 늘어서 있다.',
        '강원도 속초시 청호로 122-1', '033-639-2690'),
       (99, '강원권', '속초 해수욕장관광지',
        ...
        '강원도 속초시 해오름로 190 (조양동)', '033-639-2027'),
       (100, '강원권', '강릉 연곡해변캠핑장',
        '연곡해변캠핑장에서는 탁 트인 바다 전망과 풍성한 소나무 군락을 동시에 누릴 수 있다. 최근 해변에 자리해 있던 군사시설물을 말끔히 정리해 시야에는 오로지 넓은 바다와 흰 모래사장만 남았다. 연곡해변캠핑장의 가장 큰 묘미는 울창한 소나무 숲속에서 캠핑을 할 수 있다는 것이다. 소나무가 내뿜는 피톤치드 덕분에 산림욕을 즐기기에도 좋다. 캠핑 자리마다 거리가 확보되어 있어 독립적인 캠핑이 가능하다는 것도 장점이다.',
        '강원도 강릉시 연곡면 해안로 1282', '033-662-2900'),
       (101, '강원권', '강릉 경포해변',
        '동해안 최대 해변으로 유명하며 강문동, 안현동에 있고 시내에서 북으로 6km, 경포대에서 1km되는 곳에 동해의 창파를 가득 담고 펼쳐진 명사오리(明沙五里)이다. 모두를 삼키기라도 하려는 듯 밀려오는 파도, 이를 쓸어 안은 길이 1.8km, 면적 1.44㎢의 하얀 모래밭과, 시끄러운 일상을 조용히 차단하는 울창한 송림병풍의 조화가 해변 특유의 아름다움을 자아낸다. 경포대 해변은 백사장이 1.8km에 평균 수심이 1~2m로 적당한 깊이와 완만한 경사 때문에 해마다 많은 인파가 찾아오는 곳이다. 해변 주변에는 소나무 숲이 우거져 해수욕과 산림욕을 동시에 즐길 수 있어 피서지로 안성맞춤이다. 매년 여름마다 경포 해변 상설무대에서 여름밤 예술제가 열려 문화적인 볼거리도 다양하다. 경포호 주변에서 자전거를 대여하여 즐기는 하이킹 또한 하나의 명물이다. 또한, 주변에 설악산,오대산 국립공원이 있어 산, 바다, 계곡 등을 두루두루 돌아 볼 수 있다.',
        '강원도 강릉시 창해로 514 (안현동)', '033-640-4901'),
       (102, '강원권', '강릉 허균?허난설헌 기념공원',
        ...
        '강원도 강릉시 난설헌로193번길 1-16 (초당동)', '033-640-5119'),
       (103, '강원권', '강릉 커피거리',
        ...
        '강원도 강릉시 창해로14번길 20-1', '033-640-4537강릉시 관광안내소 033-640-4531'),
       (104, '강원권', '강릉 통일공원',
        '세계유일의 분단국이며, 분단의 허리 강원도.강원도 해안 중심도시인 강릉 안인진과 정동진에는 민족대립의 현장이며 전쟁의 슬픔이 숨어 있는 곳이다. 1950.6.25 북한군이 최초로 남침하여 상륙한 곳이며, 1996.9.18 북한잠수함이 침투하여 온 국민에게 전율을 느끼게 한곳이다.6.25전쟁과 9.18북한잠수함, 무장공비 침투 등의 아픔을 안고 있는 이곳에 평화통일을 염원하면서 국가안보의 중요성을 강조하고 안보의식을 고취하고자 함정전시관과 안보전시관으로 구성된 국내 육,해,공 3군의 군사장비와 북한잠수함 등을 한 곳에서 볼 수 있는 대규모 전시공원인 강릉통일공원을 조성하였다.그러나 21년 10월, 함정전시관에 전시된 퇴역함정 \'\'전북함\'\'은 시설 노후와 안전사고 우려로 인해 해체식을 진행, 역사 속으로 사라지게 되었다. 대신 그 자리에는 차박을 즐길 수 있는 오토캠핑장이 22년 8월경에 들어설 예정이다. 통일공원 조성의 계기가 된 북한 잠수함과 옛 전투기 등의 시설은 그대로 유지된다.',
        '강원도 강릉시 강동면 율곡로 1616', '강릉통일공원 안보전시관 033-640-4469'),
       (105, '강원권', '강릉 솔향수목원',
       ...
       (107, '강원권', '동해 망상해수욕장',
        ...
        '강원도 동해시 동해대로 6270-10 (망상동)', '033-530-2800'),
       (108, '강원권', '정선 삼탄아트마인',
        '삼탄아트마인은 1964년에서 2001년까지 삼척탄좌가 있던 자리다. 그 터 위에 옛 폐광의 흔적을 보존하며 문화예술의 가치를 입혔다. 그래서 그 이름 안에 ‘아트(예술 art)’와 마인(광산 mine)이 공존한다. 제일 먼저 만나는 장소는 삼탄아트센터 본관이다. 과거 삼척탄좌 시절 사무공간과 광원들의 공동샤워실, 수직갱을 움직이던 운전실이 있던 장소다. 이를 활용해 레지던시룸, 현대미술관 CAM1, 삼탄아트마인자료 등으로 꾸몄다. 그 가운데 옛 광원이 몸을 씻던 샤워장과 장화를 씻던 세화장 등은 마인갤러리로 변신했다. 덕분에 아주 특별한 전시 풍경을 연출한다. 레일바이뮤지엄 또한 삼탄아트마인의 자랑이다. 외부에서 진입할 때 가장 먼저 보이는 53m의 권양기가 위치한 건물이다. 권양기는 광원들이 지하 탄광으로 이동할 때 사용하던 산업용 엘리베이터다. 건물 내부는 당시의 현장을 그대로 보존해 옛 삼척탄좌의 분위기를 가장 잘 느낄 수 있다. 야외공원에는 탄광의 기계 제작 공장동을 개조한 레스토랑823L, 중앙압축기실로 쓰이던 원시미술박물관이 위치한다. 옛 탄광과 예술의 조화가 절묘해 현재와 과거의 시간을 넘나드는 듯하다.* 소장품현황 : 세계 150개국 이상에서 모든 미술품 컬렉션, 그림 조각 등 10만점 이상 소장* 할인정보 : 광부, 지역할인, 유공자 50% 할인, 프로모션 30% 할인',
        '강원도 정선군 고한읍 함백산로 1445-44', '033 591-3001'),
       (109, '제주권', '제주 사려니 숲길삼나무숲',
        ...
        '제주특별자치도 서귀포시 표선면 가시리 붉은오름 입구', '사려니숲길 탐방안내소 064-900-8800'),
       (110, '제주권', '제주 서귀포 치유의숲',
        '산림욕은 어떻게 해야 더 효과적일까?\' 이런 막연한 의문이 든다면 서귀포 치유의 숲에서 전문적인 산림 체험 프로그램을 경험해보길 바란다. 서귀포 치유의 숲에는 총 10개의 테마길이 있다. 노고록숲의 \'가멍오멍숲길\'을 시작으로 나머지 9개의 길이 나뉜다. 잣성을 옆에 두고 걷는 \'가베또롱 치유숲길\',
        단풍나무와 도토리가 가득한 \'엄부랑 치유숲길\' 등이 그것이다. 마지막으로 힐링센터에서는 사전 예약을 통해 산림 치유 지도사와 함께 다양한 치유 프로그램을 경험해볼 수 있다. 치유의 샘에서 발을 씻고 차를 나누어 마시며 명상을 하는 등 완전한 휴식을 경험할 수 있다.','제주특별자치도 서귀포시 산록남로 2271','064-760-3067~8'),(111,'제주권','제주 붉은 오름 자연휴양림','붉은오름자연휴양림은 자연을 전혀 훼손하지 않은 자연 그대로의 휴양림으로 서귀포시와 제주시 경계 지점 남조로변에 있다.총 190ha의 광활한 면적 아래 40~50년 된 곰솔과 삼나무가 숙박동 좌· 우에 자리 잡고 있으며 숙박동 뒤편으로는 고사리류를 비롯한 활엽수림대의 곶자왈이 널리 분표되어 있다. 또한,
        외곽지역에는 노루, 꿩, 복수초, 단풍나무, 구찌뽕나무, 참식나무 등 다양한 동· 식물들이 분포하고 있다.한라산 표고버섯, 벌꿀 생산지가 곳곳에 산재하고 있어 자연관광지로 최적의 조건을 갖추고 있으며,
        제주도 중산간의 전형적인 전경과 독특한 풍경이 어우러져 모든 이의 고향처럼 아늑함과 더불어 평화롭고 정겨움을 줄 수 있는 곳으로 인근에 붉은오름, 물찻오름,
        가문이 오름과 사려니 숲길 등이 자리 잡고 있다.주요 접근도로는 지방도 1118호선(남조로)이 있으며, 북쪽에 국가지원지방도 97호선(번영로), 지방도 1112호선(비자림로),
        남쪽에 1116번 중산간도로가 있다.위와 같은 접근로로 제주시에서 약 40여 분, 서귀포시에서 약 45분 정도가 소요되고,
        제주도 서쪽에서도 1시간 거리에 있으므로 제주도 전 지역에서 접근이 용이하다. 뿐만 아니라, 전국 유명관광지인 성산일출봉, 만장굴, 비자림, 돌문화공원, 성읍민속마을,
        삼다수 생산 공장이 인근 지역에 있다. 휴양림 내에는 숲속의 집, 산림문화휴양관, 생태연못, 산림욕장, 잔디광장, 세미나실, 방문자센타,
        맨발로 거닐 수 있는 산책로와 야자수 매트 탐방로 등 다양한 시설을 갖추고 있다.','제주특별자치도 서귀포시 표선면 남조로 1487-73','064-760-3481'),(112,'제주권','제주 서귀포 천지연폭포','그 이름만큼이나 빼어난 서귀포 천지연(天地淵)폭포는 조면질 안산암의 기암절벽이 하늘높이 치솟아 마치 선계(仙界)로 들어온 것같은 황홀경을 느끼게 한다. 천지연계곡에는 천연기념물로 지정된 담팔수 자생지 이외에도 가시딸기,
        송엽란 등의 희귀식물과 함께 계곡 양쪽에 구실잣밤나무, 산유자나무,
        동백나무 등의 난대성 식물들이 울창한 숲을 이루고 있어 천연기념물로 지정 보호되고 있다. 특히 담팔수나무는 담팔수과의 상록교목으로 우리나라에서는 안덕계곡, 천제연, 효돈천 등 제주도 남쪽해안이 섶섬,
        문섬 등이 그 북한지이다.이 천지연난대림지대를 따라 나 있는 산책로를 1㎞쯤 걸어 들어가면 웅장한 소리를 내며 떨어지는 폭포와 만나게 된다. 서귀포항 어귀에서 길게 뻗은 오솔길에는 꽃치자, 왕벚나무,
        철쭉 등의 아름다운 꽃나무와 더불어 정취어린 돌징검다리, 숲사이 군데군데 마련된 쉼터가 최상의 데이트 코스를 연출해주므로 신혼부부나 연인들 사이에 무척 인기가 높다. 또한 폭 12m,
        높이 22m에서 세차게 떨어져 수심 20m의 호(湖)를 이루는 천지연의 맑고 깊은 물은 천연기념물로 지정되었으며,
        무태장어(천연기념물)의 서식지로서도 유명하다. 야간조명시설이 돼있어 11~4월에는 밤 10시까지 5~10월까지는 밤 11시까지 야간관광이나 데이트를 즐길 수 있는 코스로 최적지이다. 매년 서귀포칠십리축제가 이곳을 중심으로 화려하게 펼쳐지기도 한다.* 천지연 얼굴최근 천지연 물 위에 비쳐진 바위의 형상이 사람 얼굴을 닮아 화제가 되고 있다. 천지연 기원의 다리 상류의 보 위에 자리잡고 있는 이 바위의 형상이 그 자체로는 흔한 바위지만 물 위에 비친 형상과 합쳐지면 사람의 얼굴처럼 보인다고 한다. 왼쪽에서 보면 큰 어른 얼굴이고 오른쪽에서 보면 다소곳한 어린 아기의 얼굴로 보여진다고 한다. 관광지관리사무소는 \"바위의 형상만 보면 사람의 얼굴이라는 생각이 안들지만 마치 물감을 도화지에 뿌리고 반으로 접으면 양쪽에 똑같은 그림이 나오는 것처럼 물위에 비친 형상까지 합쳐서 보면 신기하게도 사람의 얼굴임을 알 수 있다\"며 \"그 모습도 오전보다는 해가 서쪽으로 기우는 오후가 되면 더욱 뚜렷이 나타난다\"고 천지연을 찾는 관광객들에게 설명하고 있다.* 무태장어 서식지천연기념물인 무태장어는 회유성 어류로서 하천이나 호수의 비교적 깊은 곳에서 산다. 육식성이며, 깊은 바다에서 산란한다. 몸은 황갈색이고 배는 백색이며, 온몸에는 흑갈색 반문이 흩어져 있다. 낮에는 소에 숨고 밤에는 얕은 곳으로 나와 먹이를 잡아 먹는데 큰것은 길이가 2m, 무게가 20㎏에 이른다. 국가에서는 무태장어가 서식하는 천지연 일대 무태장어 서식지를 천연기념물로 지정보호하고 있다.* 서귀포층의 패류화석천지연하류 서남쪽 해변에 위치한 화석지대로서 제 3기인 플라이오세에 속하는 해성층이 발달하여 있는데 이것이 서귀포층이다. 이 지층은 주로 회색 또는 회갈색을 띤 사암류 및 점토로 구성되어 있고 조기패류와 동물화석들이 섞여 있다.','제주특별자치도 서귀포시 천지동','064-710-3945');
/*!40000 ALTER TABLE `tbl_travel` ENABLE KEYS */;
UNLOCK
TABLES;

--
-- Table structure for table `tbl_travel_image`
--
...
(
    ...
    `travel_no` int DEFAULT NULL,
    PRIMARY KEY (`no`),
    KEY         `travel_no` (`travel_no`),
    CONSTRAINT `tbl_travel_image_ibfk_1` FOREIGN KEY (`travel_no`) REFERENCES `tbl_travel` (`no`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1681 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_travel_image`
--

LOCK
TABLES `tbl_travel_image` WRITE;
/*!40000 ALTER TABLE `tbl_travel_image` DISABLE KEYS */;
INSERT INTO `tbl_travel_image`
VALUES (1, '001-1.jpg', 1),
       (2, '001-2.jpg', 1),
       (3, '001-3.jpg', 1),
       (4, '001-4.jpg', 1),
       (5, '001-5.jpg', 1),
       ...
       (1679, '112-4.jpg', 112),
       (1680, '112-5.jpg', 112);
/*!40000 ALTER TABLE `tbl_travel_image` ENABLE KEYS */;
UNLOCK
TABLES;
...
-- Dump completed on 2025-07-07  9:18:38
